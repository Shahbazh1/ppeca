  ...
  return (
    <section className="w-full bg-[#f8fafc] px-4 sm:px-5 md:px-6 lg:px-5 box-border">
      ...
      <div className="rounded-[2px] bg-[#caead4] px-4 sm:px-5 md:px-6 lg:px-[22px] py-4 sm:py-5 md:py-6 lg:py-[20px]">
        <p className="text-[14px] sm:text-[14.5px] md:text-[15px] leading-[1.5] sm:leading-[1.55] md:leading-[1.6] lg:leading-[1.65] text-[#334155] font-sans">
        ...
        <p className="text-[14px] sm:text-[14.5px] md:text-[15px] leading-[1.5] sm:leading-[1.55] md:leading-[1.6] lg:leading-[1.65] text-[#334155] font-sans mt-3 sm:mt-4 md:mt-5 lg:mt-0">
