      ...
      <div className="mx-auto max-w-7xl">
        <div className="rounded-lg border border-gray-300 bg-white px-5 sm:px-6 md:px-8 lg:px-10 py-6 sm:py-7 md:py-8">
          ...
          <div className="mt-4 sm:mt-5 md:mt-6">
            <Link  href="/news" className="cursor-pointer rounded-sm font-['Open_Sans'] bg-[#16a831] px-4 sm:px-5 md:px-6 py-2 sm:py-2.5 text-xs sm:text-sm font-semibold text-[#f8fafc] hover:bg-green-700 transition">
              Newsletter
            </Link>
          </div>
        </div>
