...
const companyData = [
  ...
  },
  {
    ...
    description: [
  "Government Holdings (Private) Limited (GHPL) is a state-owned company, incorporated in 2000 as an independent private limited entity. Established originally to manage the Government of Pakistan’s working interests in petroleum exploration and production (E&P) joint ventures, GHPL today holds one of the largest non-operating upstream portfolios in the country. GHPL also has the unique mandate of acting as the licensee for Pakistan’s offshore blocks under the Petroleum Sharing Agreement (PSA) regime, ensuring state participation in offshore E&P sector. ",
  "GHPL’s business model focuses on investing in profitable ventures following rigorous technocommercial evaluations. As a non-operating joint venture partner, GHPL works alongside a diverse mix of public and private sector companies—both local and international. GHPL plays an active and valueadding role through a lean but highly skilled team with cross-functional expertise. This approach ensures informed decision-making, responsible oversight, and constructive participation in the joint ventures.",
  "GHPL also has an established international footprint through its shareholding in Pakistan InternationalOil Limited (PIOL) where GHPL and three other state-owned entities in Pakistan are partner in an oiland gas concession in Abu Dhabi with ADNOC, marking a milestone in Pakistan’s entry intointernational E&P markets. Building on this foundation, GHPL aspires to expand its global presencethrough commercially sound partnerships in resource-rich jurisdictions.",
  "In addition to the core business, GHPL holds equity in Pakistan LNG Limited (PLL) and Inter State GasSystems (ISGS), broadening its presence across the energy value chain. The company has also enteredthe minerals sector through its investment in the world-class Reko Diq copper-gold project, inpartnership with Barrick and other state-owned enterprises. GHPL plays a key role in the Reko Diqproject through Pakistan Minerals Private Limited (PMPL), an SPV established to manage theinvestment of SOEs in this landmark project. GHPL considers mining as a focus area and aims to workwith local and international partners in supporting the government’s objective of scaling this sector inthe country. These strategic investments position GHPL to support Pakistan’s evolving energylandscape and respond to the shifting global dynamics of the natural resources sector.",]
,
...
,
  ...
  },
  {
    ...
    address:
      "PTET House, Mauve Area, Sector G-10/4, P.O. Box #1325, Islamabad, Pakistan",
    ceo: "Mr. Kamran Ahmed (Chief Executive Officer)",
    designation: "",
    description: [
      "Orient Petroleum Inc. (“ORIENT PETROLEUM”) is registered in Cayman Islands and is the successor to Occidental of Pakistan Inc., a wholly owned subsidiary of Occidental Petroleum, which commenced operations in Pakistan during 1979. In 1995, Mr. Sadruddin Hashwani acquired entire shareholding of Occidental of Pakistan Inc., and rebranded it as Orient Petroleum Inc.",
      "Orient Petroleum is the Operator of Dhurnal Mining Lease, Bhangali and Ratana D&P Leases, and is a non-operating Joint Venture Partner in Chanda and Sinjhoro Block D&P Leases, as well as in Kohlu, Waziristan, Sinjhoro, Offshore Deep A, Offshore Deep E, and Offshore Ultra Deep B Exploration Licences. In addition, Orient Petroleum is also operating three Exploration Licences: Sakhi Sarwar, Harnai South, and Marwat.",
      "It has joint venture Partnerships with leading local and international E&P companies in Pakistan, including Oil & Gas Development Company Limited, Mari Energies Limited, The Attock Oil Company Limited, Pakistan Oilfields Limited, Government Holdings (Private) Limited, Prime International Oil & Gas Company Limited, and Zaver Petroleum Corporation (Pvt.) Limited.",
      "The Company has conducted several community welfare projects, both mandatory and voluntary, for the local population. These include, but are not limited to, free eye camps, free medicine supplies, building classrooms for schools, constructing community roads, providing IT equipment to schools, installing solar tube wells for drinking water, and implementing agro-based entrepreneurship programs for poor farmers and landowners.",
      "ORIENT PETROLEUM takes pride in harnessing the expertise, experience, and technical knowledge of highly qualified Pakistani professionals. The company’s strength lies in its team’s ability to conceptualize and execute technically sound and economically viable projects. The goal is to enhance local production through exploration and enhanced secondary recovery methods and to make country self-reliant for its energy needs.",
      "The Company remains committed to investing in Pakistan’s Oil and Gas sector and continues to lead the field in innovative financial and technical solutions, reinforcing its industry reputation and supporting sustained corporate growth.",
]
,
