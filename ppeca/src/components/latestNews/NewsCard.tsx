  ...
  return (
    <div className="w-full  bg-[#f8fafc] px-4 py-5 border-[#818f9e] border-b-[0.35px] rounded-b-[5.53px]">
      ...
      <Link
        ...
        line-clamp-2"
      >
        {title || "No Title Available for News"}
      </Link>

      {/* CONTENT */}
      <div className="flex gap-4 items-start sm:flex-row flex-col">
        {/* IMAGE */}
        <div className="relative w-full sm:w-[130px] h-[180px] sm:h-[110px] flex-shrink-0">
          {image ? (
            <Image
              src={image}
        ...
        <div className="flex flex-col gap-2 w-full">
          {/* DESCRIPTION */}
          <p
            className="leading-[1.3] font-medium font-['Montserrat'] text-[#3F3F3F]
            xl:text-[17px]
            lg:text-[16.6px]
            md:text-[15px]
            sm:text-[13.5px]
          ...
          {/* META */}
          <span
            className="leading-[1.3] text-[#717171]
            lg:text-[12px]
            md:text-[11px]
            sm:text-[10px]
            text-[9px]"
